  ...
  return (
    ...
    >
        <div className="w-full">
            <div className="w-full max-w-md mx-auto rounded-xl p-5 backdrop-blur-sm bg-slate-700/30">
                <h1 className='text-white text-2xl text-center px-4 pb-4 pt-2  shadow-xl'>Simple Currency Converter</h1>
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        convert()
